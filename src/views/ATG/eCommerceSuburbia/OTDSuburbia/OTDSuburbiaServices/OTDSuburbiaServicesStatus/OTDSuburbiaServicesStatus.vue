...
export default {
  name: 'OTDSuburbiaServicesStatus',
  ...
  methods: {
    ...
    loadData: function () {
      ...
      if(this.env == "drp")
      {
        axios.get('http://localhost:9001/otdsubmondrp/' + this.server + "/" + this.service).then(function (responsedrp)
        {
           //console.log("res drp: " + JSON.stringify(responsedrp.data[0].servicios[0].componentes,undefined,2))
           this.otdsubmondrp = responsedrp.data[0].servicios[0].componentes
           ...
           //console.log("espejo drp: " + JSON.stringify(espejo,undefined,2))
            axios.get('http://localhost:9001/otdsubmonprd/' + espejo + "/" + this.service).then(function (responseprd)
            {
              ...
              this.otdsubmonprd = responseprd.data[0].servicios[0].componentes
      ...
      else if (this.env == "prd")
      {
        ...
        axios.get('http://localhost:9001/otdsubmonprd/' + this.server + "/" + this.service).then(function (responseprd)
        {
           //console.log("res drp: " + JSON.stringify(responsedrp.data[0].servicios[0].componentes,undefined,2))
           this.otdsubmonprd = responseprd.data[0].servicios[0].componentes
           ...
           this.prdserviceprd = this.service
           //console.log("espejo drp: " + JSON.stringify(espejo,undefined,2))
            axios.get('http://localhost:9001/otdsubmondrp/' + espejo + "/" + this.service).then(function (responsedrp)
            {
              //console.log("espejo prd: " + JSON.stringify(responseprd,undefined,2))
              //console.log("res prd: " + JSON.stringify(responseprd.data[0].servicios[0].componentes, undefined,2))
              this.otdsubmondrp = responsedrp.data[0].servicios[0].componentes
