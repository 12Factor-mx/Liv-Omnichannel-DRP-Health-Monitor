<template>
  <div class="animated fadeIn">
    <b-row>
      <b-col md="12">
        <b-card  header="eCommerce Liverpool">
            <b-row >
              <b-col  lg="6">
                <p>
                ...
                <b-table :items="ecommercelmonprd" hover="hover" striped="striped" bordered="bordered"  responsive="sm" :fields="fields">  
                  ...
                  <template slot="Fecha Consulta" slot-scope="data">
                   ...
                   <template slot="porcentaje" slot-scope="ecommercelmonprd">
                    {{formatPercentage(ecommercelmonprd.item.porcentaje)}}
                  </template>
              ...
              <b-col lg="6">
                ...
                <b-table  :items="ecommercelmondrp" hover="hover" striped="striped" bordered="bordered"   responsive="sm" :fields="fields">  
                  ...
                  <template slot="Fecha Consulta" slot-scope="data">
                   ...
                   <template slot="porcentaje" slot-scope="ecommercelmondrp">
                    {{formatPercentage(ecommercelmondrp.item.porcentaje)}}
                  </template>    
