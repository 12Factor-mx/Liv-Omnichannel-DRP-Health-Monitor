const Otdlmondrp = require('../model/otdlmondrp.js');
...
const updateOtdLMonDrpStatus = (body) => {
  return axios.put('http://localhost:9001/otdlmondrp/OtdLiverpool', body)
    .then((response) => {
      console.log(" put http://localhost:9001/otdlmondrp/OtdLiverpool result: \n" + JSON.stringify(response.data, undefined, 2));
      return response.data;
    })
    .catch(e => {
      console.log(e)
